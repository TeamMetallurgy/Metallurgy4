...
public class ItemMetallurgyArmor extends ItemArmor
{
    ...
    public ItemMetallurgyArmor(int id, EnumArmorMaterial armorMaterial, int renderIndex, int armorPart, String modelTexture)
    {
        super(id, armorMaterial, renderIndex, armorPart);
